...
public final class ModelInitializer
{
     ...
     *
     * @param pathName Dateipfad der Datei, in der die Quizfragen erwartet werden.
     * @return <code>Model</code> der Quizaufgabe
     * @throws IOException               wird geworfen, wenn aus irgendeinem Grund das Einlesen der
     *                                   Datei nicht funktioniert. Hierzu geh�rt u.a die {@link }.
     * @throws NumberFormatException     wird geworfen, wenn eine Dateizeile nicht interpretiert
     *                                   werden kann, weil der Index f�r die korrekte Antwort nicht
     *                                   eingelesen werden konnte.
     * @throws IndexOutOfBoundsException wird geworfen, wenn eine Dateizeile nicht interpretiert
     *                                   werden kann, weil mind. eine der geschweiften Klammern nicht
     *                                   oder an falscher Position gefunden wird.
     * @throws IllegalArgumentException  wird beim Erzeugen einer <code>Question</code> geworfen, wenn
